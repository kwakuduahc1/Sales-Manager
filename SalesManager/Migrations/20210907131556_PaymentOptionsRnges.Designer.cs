...
namespace SalesManager.Migrations
{
    ...
    [Migration("20210907131556_PaymentOptionsRnges")]
    partial class PaymentOptionsRnges
    {
            ...
            modelBuilder.Entity("SalesManager.Model.Items", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemsID = 1,
                            DateAdded = new DateTime(2021, 9, 7, 13, 15, 55, 936, DateTimeKind.Utc).AddTicks(8018),
                            Group = "Consoles",
                        ...
                        {
                            ItemsID = 2,
                            DateAdded = new DateTime(2021, 9, 7, 13, 15, 55, 937, DateTimeKind.Utc).AddTicks(133),
                            Group = "Consoles",
                            ItemName = "XBox One",
                            MinimumStock = 10
                        },
                        ...
                        {
                            ItemsID = 3,
                            DateAdded = new DateTime(2021, 9, 7, 13, 15, 55, 937, DateTimeKind.Utc).AddTicks(141),
                            Group = "Consoles",
                            ItemName = "XBox 360",
                            MinimumStock = 15
                        },
                        ...
                        {
                            ItemsID = 4,
                            DateAdded = new DateTime(2021, 9, 7, 13, 15, 55, 937, DateTimeKind.Utc).AddTicks(145),
                            Group = "Consoles",
                            ItemName = "XBox",
                            MinimumStock = 5
                        },
                        ...
                        {
                            ItemsID = 5,
                            DateAdded = new DateTime(2021, 9, 7, 13, 15, 55, 937, DateTimeKind.Utc).AddTicks(149),
                            Group = "Contollers",
                        ...
                        {
                            ItemsID = 6,
                            DateAdded = new DateTime(2021, 9, 7, 13, 15, 55, 937, DateTimeKind.Utc).AddTicks(157),
                            Group = "Contollers",
