...
namespace SalesManager.Migrations
{
    ...
    [Migration("20230508170623_UnitVal")]
    partial class UnitVal
    {
            ...
            modelBuilder.Entity("SalesManager.Model.Items", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemsID = 1,
                            DateAdded = new DateTime(2023, 5, 8, 17, 6, 23, 268, DateTimeKind.Utc).AddTicks(962),
                            Group = "Consoles",
                        ...
                        {
                            ItemsID = 2,
                            DateAdded = new DateTime(2023, 5, 8, 17, 6, 23, 268, DateTimeKind.Utc).AddTicks(977),
                            Group = "Consoles",
                            ItemName = "XBox One",
                            MinimumStock = 10
                        },
                        ...
                        {
                            ItemsID = 3,
                            DateAdded = new DateTime(2023, 5, 8, 17, 6, 23, 268, DateTimeKind.Utc).AddTicks(982),
                            Group = "Consoles",
                            ItemName = "XBox 360",
                            MinimumStock = 15
                        },
                        ...
                        {
                            ItemsID = 4,
                            DateAdded = new DateTime(2023, 5, 8, 17, 6, 23, 268, DateTimeKind.Utc).AddTicks(985),
                            Group = "Consoles",
                            ItemName = "XBox",
                            MinimumStock = 5
                        },
                        ...
                        {
                            ItemsID = 5,
                            DateAdded = new DateTime(2023, 5, 8, 17, 6, 23, 268, DateTimeKind.Utc).AddTicks(989),
                            Group = "Contollers",
                        ...
                        {
                            ItemsID = 6,
                            DateAdded = new DateTime(2023, 5, 8, 17, 6, 23, 268, DateTimeKind.Utc).AddTicks(998),
                            Group = "Contollers",
