...
namespace SalesManager.Migrations
{
    ...
    [Migration("20210704130144_StockDetailsDate")]
    partial class StockDetailsDate
    {
            ...
            modelBuilder.Entity("SalesManager.Model.Items", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemsID = 1,
                            DateAdded = new DateTime(2021, 7, 4, 13, 1, 43, 569, DateTimeKind.Utc).AddTicks(8576),
                            Group = "Consoles",
                        ...
                        {
                            ItemsID = 2,
                            DateAdded = new DateTime(2021, 7, 4, 13, 1, 43, 570, DateTimeKind.Utc).AddTicks(1849),
                            Group = "Consoles",
                            ItemName = "XBox One",
                            MinimumStock = 10
                        },
                        ...
                        {
                            ItemsID = 3,
                            DateAdded = new DateTime(2021, 7, 4, 13, 1, 43, 570, DateTimeKind.Utc).AddTicks(1865),
                            Group = "Consoles",
                            ItemName = "XBox 360",
                            MinimumStock = 15
                        },
                        ...
                        {
                            ItemsID = 4,
                            DateAdded = new DateTime(2021, 7, 4, 13, 1, 43, 570, DateTimeKind.Utc).AddTicks(1875),
                            Group = "Consoles",
                            ItemName = "XBox",
                            MinimumStock = 5
                        },
                        ...
                        {
                            ItemsID = 5,
                            DateAdded = new DateTime(2021, 7, 4, 13, 1, 43, 570, DateTimeKind.Utc).AddTicks(1884),
                            Group = "Contollers",
                        ...
                        {
                            ItemsID = 6,
                            DateAdded = new DateTime(2021, 7, 4, 13, 1, 43, 570, DateTimeKind.Utc).AddTicks(1900),
                            Group = "Contollers",
