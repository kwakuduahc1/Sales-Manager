...
namespace SalesManager.Migrations
{
    ...
    [Migration("20210624122334_SeedData")]
            ...
            modelBuilder.Entity("SalesManager.Model.Items", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemsID = 1,
                            DateAdded = new DateTime(2021, 6, 24, 12, 23, 33, 869, DateTimeKind.Utc).AddTicks(2494),
                            Group = "Consoles",
                        ...
                        {
                            ItemsID = 2,
                            DateAdded = new DateTime(2021, 6, 24, 12, 23, 33, 869, DateTimeKind.Utc).AddTicks(4808),
                            Group = "Consoles",
                            ItemName = "XBox One",
                            MinimumStock = 10
                        },
                        ...
                        {
                            ItemsID = 3,
                            DateAdded = new DateTime(2021, 6, 24, 12, 23, 33, 869, DateTimeKind.Utc).AddTicks(4818),
                            Group = "Consoles",
                            ItemName = "XBox 360",
                            MinimumStock = 15
                        },
                        ...
                        {
                            ItemsID = 4,
                            DateAdded = new DateTime(2021, 6, 24, 12, 23, 33, 869, DateTimeKind.Utc).AddTicks(4822),
                            Group = "Consoles",
                            ItemName = "XBox",
                            MinimumStock = 5
                        },
                        ...
                        {
                            ItemsID = 5,
                            DateAdded = new DateTime(2021, 6, 24, 12, 23, 33, 869, DateTimeKind.Utc).AddTicks(4825),
                            Group = "Contollers",
                        ...
                        {
                            ItemsID = 6,
                            DateAdded = new DateTime(2021, 6, 24, 12, 23, 33, 869, DateTimeKind.Utc).AddTicks(4834),
                            Group = "Contollers",
