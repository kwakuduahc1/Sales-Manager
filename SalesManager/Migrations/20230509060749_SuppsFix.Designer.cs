...
namespace SalesManager.Migrations
{
    ...
    [Migration("20230509060749_SuppsFix")]
    partial class SuppsFix
    {
            ...
            modelBuilder.Entity("SalesManager.Model.Items", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemsID = 1,
                            DateAdded = new DateTime(2023, 5, 9, 6, 7, 48, 918, DateTimeKind.Utc).AddTicks(4098),
                            Group = "Consoles",
                        ...
                        {
                            ItemsID = 2,
                            DateAdded = new DateTime(2023, 5, 9, 6, 7, 48, 918, DateTimeKind.Utc).AddTicks(4115),
                            Group = "Consoles",
                            ItemName = "XBox One",
                            MinimumStock = 10
                        },
                        ...
                        {
                            ItemsID = 3,
                            DateAdded = new DateTime(2023, 5, 9, 6, 7, 48, 918, DateTimeKind.Utc).AddTicks(4120),
                            Group = "Consoles",
                            ItemName = "XBox 360",
                            MinimumStock = 15
                        },
                        ...
                        {
                            ItemsID = 4,
                            DateAdded = new DateTime(2023, 5, 9, 6, 7, 48, 918, DateTimeKind.Utc).AddTicks(4123),
                            Group = "Consoles",
                            ItemName = "XBox",
                            MinimumStock = 5
                        },
                        ...
                        {
                            ItemsID = 5,
                            DateAdded = new DateTime(2023, 5, 9, 6, 7, 48, 918, DateTimeKind.Utc).AddTicks(4128),
                            Group = "Contollers",
                        ...
                        {
                            ItemsID = 6,
                            DateAdded = new DateTime(2023, 5, 9, 6, 7, 48, 918, DateTimeKind.Utc).AddTicks(4138),
                            Group = "Contollers",
